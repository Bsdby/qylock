...
Rectangle {
    ...
    Rectangle {
        ...
        Column {
            ...
            OsuMenuItem { anchors.horizontalCenter: parent.horizontalCenter; label: "Back to Menu"; centered: true; iconColor: "#662D91"; onActivated: { root.randomizeTheme(); failOverlay.opacity = 0; resetGame(); passField.text = ""; passField.forceActiveFocus(); root.gameActive = false } }
        }
    }
